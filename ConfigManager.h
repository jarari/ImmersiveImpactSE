...
enum iConfigType {
	...
	Knockback_1H,
	Knockback_2H,
	Knockback_Fist_Duration,
	Knockback_Dagger_Duration,
	Knockback_1H_Duration,
	Knockback_2H_Duration,
	...
	HitShakeController_PowerAttackMult,
